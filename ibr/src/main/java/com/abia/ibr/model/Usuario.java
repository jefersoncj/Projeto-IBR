...
public class Usuario implements Serializable {
	...
	public Usuario(Long codigo, String nome, String sobrenome, String nomeIgreja, String email, String senha,
			String confirmacaoSenha, Boolean ativo, String tenantId, List<Grupo> grupos, LocalDate dataNascimento) {
		super();
		this.codigo = codigo;
		this.nome = nome;
