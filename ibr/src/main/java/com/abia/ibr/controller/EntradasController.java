...
public class EntradasController {
	...
	@RequestMapping("/nova")
	public ModelAndView nova(Movimento movimento) {
		ModelAndView mv = new ModelAndView("entrada/CadastroEntrada");
	...
	public @ResponseBody List<Item> pesquisar(String nomeGrupoContaOuSubgrupo) {
		return itens.porNomeGrupoContaOuSubgrupo(nomeGrupoContaOuSubgrupo,"C");
	}
	...
	public ModelAndView pesquisar(MovimentoFilter movimentoFilter, BindingResult result) {
		ModelAndView mv = new ModelAndView("entrada/BuscaEntradas");
		...
		List<Item> listaItem = itens.porNomeGrupoContaOuSubgrupo("","C");
		...
		mv.addObject("contas", contas.findAll());
		movimentoFilter.setTipo(Tipo.C);
